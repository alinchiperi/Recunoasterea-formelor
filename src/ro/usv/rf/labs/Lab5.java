...
//		System.out.println("Set 6 - test_data.csv + classNames[M+1]:\n" + countyLearningSet);
        ...
        double[] countryTest = new double[]{25.89, 47.56, 24, 45.15, 25.33, 45.44};

        for (int i = 0; i < countryTest.length; i += 2) {

            int iclass = classif_kNN_Euclid.predict(new double[]{countryTest[i], countryTest[i + 1]});
